...
public partial class TableViewModel : SelectableElement
{
    ...
    partial void OnXChanged(double value)
    {
        ...
        _x = Helpers.MathHelper.RoundToNearestValue(MainViewModel.Instance.Settings.PositionSnapping, value);
        VisualPropertyChanged?.Invoke(this, this);
    }
    partial void OnYChanged(double value)
    {
        //Setting the field is ok, otherwise a stackoverflowexception would be thrown
        _y = Helpers.MathHelper.RoundToNearestValue(MainViewModel.Instance.Settings.PositionSnapping, value);
        VisualPropertyChanged?.Invoke(this, this);
    }
    partial void OnHeightChanged(double value)
    {
        _height = Helpers.MathHelper.RoundToNearestValue(MainViewModel.Instance.Settings.SizeSnapping, value);
        VisualPropertyChanged?.Invoke(this, this);
    }

    partial void OnWidthChanged(double value)
    {
        _width = Helpers.MathHelper.RoundToNearestValue(MainViewModel.Instance.Settings.SizeSnapping, value);
        VisualPropertyChanged?.Invoke(this, this);
    }
